...
- 167 unit tests, TypeScript, ESLint and Next production build passed. Real container FFmpeg fixture produced 1080x1920 H.264/AAC with Vietnamese SRT, 2.437 s for a 2.4 s concatenation. This is a technical fixture, not a character-consistency canary.
