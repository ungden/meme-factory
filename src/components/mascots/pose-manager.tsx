...
/**
 * Raw pose management for one mascot: upload, bulk upload, AI generation, avatar
 * and deletion. Lifted out of the retired /characters route so a mascot is one
 * page with tabs rather than two pages about the same row.
 */
export default function PoseManager({
  ...
  const handleDelete = async () => {
    ...
    router.push(`/projects/${projectId}/mascots`);
  };
  ...
  if (!character) {
    return (
      <div className="flex flex-col items-center justify-center py-20">
        ...
        <Button variant="outline" onClick={() => router.push(`/projects/${projectId}/mascots`)}>
                    ...
                    <div className="aspect-square flex items-center justify-center th-bg-tertiary relative">
                      {pose.image_url && !pose.image_url.startsWith("/mock/") ? (
                        ...
                        <div className="text-center p-2">
                          <ImageIcon size={28} className="mx-auto th-text-muted" />
        ...
        <Modal isOpen={showAiPoseModal} onClose={() => setShowAiPoseModal(false)} title="Tạo nhân vật bằng AI" size="xl">
          <div className="space-y-5">
            ...
            <div className="p-2 rounded-lg th-bg-tertiary text-xs th-text-secondary">
              AI sẽ tạo 1 <strong>ảnh nhân vật gốc</strong> (không khóa biểu cảm). Biểu cảm sẽ được xử lý theo từng meme sau này.
            </div>
