...
Viết bản đầy đủ bằng tiếng Việt, khai thác hành vi/quan hệ cụ thể đã chọn. Với tập hài, không chỉ minh họa một phép đảo vai hoặc gắn micro vào chuyện kể. Với tập cảm động, không ép đảo vai/parody/joke; gieo hình ảnh hoặc hành động tạo cảm xúc trước lời nói cuối. Giữ các câu phản ứng có tác dụng, không bắt mỗi câu là một trò đùa. Khác biệt hai bé phải thể hiện qua cách xử lý/đối đáp, không chỉ đổi tên người nói.
