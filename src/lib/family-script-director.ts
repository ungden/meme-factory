...
Audit intentCheck độc lập với lời tự mô tả của người viết. Tách các chi tiết người dùng yêu cầu rõ, nhất là diễn biến cuối hoặc câu/ý kết thúc. Liệt kê từng cảnh/hành động cụ thể trong ý tưởng (ví dụ cõng con đi dọc biển, hồi tưởng, đặt con xuống) và kiểm tra mỗi cái có lượt riêng; một cảnh chỉ được nhắc lướt trong setup hoặc action của lượt khác là THIẾU. Lượt text rỗng là nhịp không lời hợp lệ, không phải lỗi thoại. status=faithful chỉ khi thoại hoặc hành động THỰC SỰ diễn đủ chi tiết ấy; evidence phải trích nguyên văn từ bản diễn. Một hành động xảy ra sớm hơn, một kết tương tự hoặc outcome tự khai không được thay thế yêu cầu. Nếu người dùng không chỉ định kết cụ thể, kiểm tra chủ đề và quan hệ cốt lõi. Thiếu một nhịp bắt buộc thì needs_revision và không được ready_for_user.
