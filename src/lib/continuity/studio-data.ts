...
export const assets: Asset[] = [
  {
    ...
    coverage: 92,
    referenceCount: 4,
    notes: "Tóc bob đen ngắn, da tông ấm, khuôn mặt trái xoan. Giữ nguyên tỷ lệ khuôn mặt và cơ thể.",
    isSample: true,
  },
  {
    id: "char_minh",
  ...
  },
  {
    ...
    name: "Hẻm Sài Gòn — trời mưa",
    kind: "environment",
    status: "locked",
    thumbnail: "/continuity/saigon-alley.webp",
    coverage: 86,
    referenceCount: 3,
    notes: "Hẻm hẹp ướt mưa, đèn xanh lục lam và đỏ ấm, bối cảnh nửa đêm sau mưa.",
    isSample: true,
  },
  {
    id: "style_editorial",
    versionId: "style_editorial_v1",
    name: "Biên tập điện ảnh",
    kind: "style",
    status: "locked",
    thumbnail: "/continuity/cinematic-style.webp",
    coverage: 78,
    referenceCount: 2,
    notes: "Thời trang cao cấp, chất phim 35mm, da chân thực và màu phim tiết chế.",
    isSample: true,
  },
];
