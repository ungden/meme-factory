  ...
  return (
    <div className="max-w-3xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
      <div className="max-w-none">
        <h1 className="text-3xl font-extrabold tracking-tight th-text-primary sm:text-4xl mb-8">
          Điều khoản sử dụng (Terms of Service)
        </h1>
        <p className="th-text-tertiary mb-8">Cập nhật lần cuối: 10/09/2026</p>

        <section className="mb-8">
          <h2 className="text-2xl font-bold th-text-primary mb-4">1. Chấp nhận điều khoản</h2>
          <p className="th-text-secondary mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold th-text-primary mb-4">2. Mô tả dịch vụ</h2>
          <p className="th-text-secondary mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold th-text-primary mb-4">3. Tài khoản và Bảo mật</h2>
          <ul className="list-disc pl-6 th-text-secondary space-y-2 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold th-text-primary mb-4">4. Trách nhiệm về Nội dung (User-Generated Content)</h2>
          <p className="th-text-secondary mb-4">Khi sử dụng AIDA để tạo nội dung, bạn đồng ý tuân thủ các quy tắc sau:</p>
          <ul className="list-disc pl-6 th-text-secondary space-y-2 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold th-text-primary mb-4">5. Thanh toán và Điểm (Points)</h2>
          <ul className="list-disc pl-6 th-text-secondary space-y-2 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold th-text-primary mb-4">6. Quyền Sở hữu trí tuệ</h2>
          <p className="th-text-secondary mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold th-text-primary mb-4">7. Sửa đổi Điều khoản</h2>
          <p className="th-text-secondary mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold th-text-primary mb-4">8. Liên hệ</h2>
          <p className="th-text-secondary mb-4">
