  ...
  return <div className="flex"><Sidebar projectId={projectRef} projectName={project?.name} />
    <main className="ml-0 min-h-screen flex-1 p-4 pt-16 lg:ml-56 md:p-8 lg:p-10">
      <div className="mx-auto max-w-7xl">
        <header className="mb-6 flex flex-wrap items-end justify-between gap-4"><div><h1 className="text-2xl font-semibold tracking-tight th-text-primary">Tạo video</h1><p className="mt-1 text-sm th-text-tertiary">Một clip ngắn từ mô tả hoặc ảnh trong dự án. Cần câu chuyện hoàn chỉnh? Chọn Tạo phim ngắn.</p></div><nav className="flex rounded-lg border p-1" style={{ borderColor: "var(--border-primary)" }} aria-label="Công cụ video"><span className="rounded-md px-3 py-2 text-sm font-semibold th-bg-accent-light th-text-accent">Tạo video</span><Link className="rounded-md px-3 py-2 text-sm font-medium th-text-secondary th-bg-hover" href={`/projects/${projectRef}/video/multiscene`}>Tạo phim ngắn</Link></nav></header>
